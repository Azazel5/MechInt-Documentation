...
![20 experimental fact categories used in BizzaroWorld, spanning geography, science, animals, history, and other knowledge domains](./images/experimental-categories.png){fig-alt="Grid or list of the 20 fact categories designed for the BizzaroWorld prompt battery"}

![TotalSwing metric by fact category in Gemma 12B-IT — variation in how strongly different knowledge types are encoded in the factual recall circuit](./images/Gemma12B-categories-totalswing.png){fig-alt="Bar chart of TotalSwing scores per knowledge category for Gemma 12B-IT, showing which fact types have the strongest and weakest circuit encoding"}
